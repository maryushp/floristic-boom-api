...
public class Constants {
    ...
    public static final String FLOWER_UNAVALIABLE = "Flower Unavaliable";
    public static final String FLOWER_ALREADY_EXISTS = "Flower with name already exists";
    public static final String BOUQUET_ALREADY_EXISTS = "Bouquet already exists";
    public static final String DELIVERY_TYPE_ALREADY_EXISTS = "Delivery type with name %s already exists";
    public static final String DELIVERY_TYPE_NOT_FOUND = "Delivery type with id %d not found";
    ...
    public static final String BOUQUET_NOT_FOUND_ID = "Bouquet with id %d not found";
